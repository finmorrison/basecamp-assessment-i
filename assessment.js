...
var notHakeem = function hakeem() {
  if ('Hakeem Olajuwon' == myName) {
    return true;
  }  else {
      return ("not equal");
  }
}
console.log(notHakeem('Hakeem Olajuwon'));
